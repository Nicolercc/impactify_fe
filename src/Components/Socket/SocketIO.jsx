...
export const SocketProvider = ({ children }) => {
	...
	useEffect(() => {
		// Only create socket if backendURL is defined
		if (!backendURL) {
			console.warn("Backend URL not configured, skipping socket connection");
			return;
		}
		...
		socketInstance.on("connect_error", (error) => {
			console.error(
				"Connection error: Somethings wrong with my backend",
				error
			);
		});
